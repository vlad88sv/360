...
function checkCreditCard ($cardnumber, $cardname, &$errornumber, &$errortext) {
  ...
  $ccErrors [0] = 'Tipo invalido de tarjeta';
  $ccErrors [1] = 'El número de tarjeta de credito no fue provisto';
  $ccErrors [2] = "El número de tarjeta de credito tiene formato inválido";
  $ccErrors [3] = "El número de tarjeta de credito es inválido";
  $ccErrors [4] = "El número de tarjeta de credito no tiene la cantidad de digitos necesarios";
